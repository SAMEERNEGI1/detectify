...
# Load YOLO model
MODEL_PATH = r"C:\Users\samee\OneDrive\Desktop\detectify 2.0\ml-ai\runs\train\exp\weights\best.pt"
...
def detect_api():
    """
    API endpoint to accept an image, run object detection, and return the JSON result.
    """
